...
export class FriendshipController {
  ...
  async getFriendList(@Req() req: Request, @Res() res: Response) {
    const data = await this.friendshipService.getFriendList(
  ...
  async addFriend(@Req() req: Request, @Res() res: Response) {
    const data = await this.friendshipService.addFriend(
      (req.user as UserTokenDtoType).userId,
      req.params.friendId,
    )
  ...
  async rejectFriend(@Req() req: Request, @Res() res: Response) {
    await this.friendshipService.rejectFriend(
      (req.user as UserTokenDtoType).userId,
      req.params.friendId,
    )
  ...
  async searchUser(@Req() req: Request, @Res() res: Response) {
    const data = await this.friendshipService.searchUser(
